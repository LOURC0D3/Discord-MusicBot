...
class MusicBot(discord.Client):
    ...
    def _gen_embed(self):
        ...
        e.colour = 7506394
        e.set_footer(
            text=self.config.footer_text, icon_url="https://cdn.discordapp.com/avatars/880806484722712626/ca076e0b62a0ede6913da1b2eeb11c0d.webp?size=128"
        )
        e.set_author(
            name=self.user.name,
            url="https://lourcode.kr",
